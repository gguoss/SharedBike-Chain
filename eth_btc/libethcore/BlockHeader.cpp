...
#include <libbitcoin/streams.h>
#include <libbitcoin/version.h>
...
void BlockHeader::setAuxPow(std::string const& auxpow)
{
    const std::vector<unsigned char> vchAuxPow = ParseHex(auxpow);
    CDataStream ss(vchAuxPow, SER_GETHASH, PROTOCOL_VERSION);
    CAuxPow pow;
    ss >> pow;
    m_auxpow.reset(new CAuxPow(pow));
    s_auxpow = auxpow;
}
