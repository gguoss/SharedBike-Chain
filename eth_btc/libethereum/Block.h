...
public:
	 ...
	 * @endcode
	 */
	bool sealBlock(bytes const& _header, std::string const& auxpow) { return sealBlock(&_header, auxpow); }
	bool sealBlock(bytesConstRef _header, std::string const& auxpow);
