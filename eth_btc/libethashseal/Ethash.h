...
public:
	...
	static h256 boundary(BlockHeader const& _bi) { auto d = _bi.difficulty();
                                                    std::cout<<"--difficulty:"<<d<<std::endl;
	...
	void manuallySubmitAuxBlock(h256 const& hash, std::string const& auxpow);
